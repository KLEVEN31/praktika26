...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, String> CUSTOMER_NAME = createField(DSL.name("customer_name"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>purchase.customer.customer_inn</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_INN = createField(DSL.name("customer_inn"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>purchase.customer.customer_kpp</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_KPP = createField(DSL.name("customer_kpp"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>purchase.customer.customer_legal_address</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_LEGAL_ADDRESS = createField(DSL.name("customer_legal_address"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>purchase.customer.customer_postal_address</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_POSTAL_ADDRESS = createField(DSL.name("customer_postal_address"), SQLDataType.VARCHAR(255), this, "");
